...
Note: This script assumes that filenames contain a part after an underscore indicating the run ID (e.g., ''001_000007_000001.dcm' corresponds to the first scan in run 7').
"""

...
# SAVE STACKED DATA
vols_of_interest.to_filename(str(stacked_vols_of_interest_dir / 'examples_detrended_zscored_stacked_vols_of_interest_searchlight.nii.gz'))
stacked_behav_perception.to_csv(str(stacked_vols_of_interest_dir / 'examples_detrended_zscored_stacked_vols_of_interest_searchlight.csv'))
np.save(str(stacked_vols_of_interest_dir / 'zscoring_mean_array.npy'), mean_array)
np.save(str(stacked_vols_of_interest_dir / 'zscoring_std_array.npy'), std_array)

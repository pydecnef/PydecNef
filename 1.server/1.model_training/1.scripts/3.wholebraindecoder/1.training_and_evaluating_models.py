...
########################################################
    ...
    print(exp_dir)
    data_dir = exp_dir / '2.data/preprocessed/stacked_vols_of_interest/'
    working_data = str(data_dir / 'examples_detrended_zscored_stacked_vols_of_interest_searchlight.nii.gz')
    wholebrain_mask = os.path.join(str(exp_dir), "2.data","preprocessed", "example_func","example_func_deoblique_brainmask.nii")
